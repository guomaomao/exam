...
/**
 * Created by seatrend on 2018/10/15.
 */

public class ExamAfterResultEntity {
     ...
     * checkerId : string
     * checkstate : string
     * checktime : 2018-10-15T05:58:02.754Z
     * checktype : string
     * examroom : string
     * examsubject : string
     * examtime : 2018-10-15T05:58:02.754Z
     * id : string
     * middlechecker : string
     * middleid : string
     * middletime : 2018-10-15T05:58:02.754Z
     ...
     * projects : [{"checkpoint":"检查要点：按对应编号传入","id":"null","photo":"检查处置图片id","pointtype":"要点类别：候考区","remark":"处置","result":"检查处置结果，例：正常","resultOrder":"检查处置结果的顺序，从1开始，整数类型"}]
     */
    ...
    public static class ProjectsBean {
        /**
         * checkpoint : 检查要点：按对应编号传入
         * id : null
         * photo : 检查处置图片id
         * pointtype : 要点类别：候考区
         * remark : 处置
         * result : 检查处置结果，例：正常
         * resultOrder : 检查处置结果的顺序，从1开始，整数类型
         */
